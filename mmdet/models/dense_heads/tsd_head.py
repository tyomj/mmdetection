...
from mmdet.core import bbox_target_tsd, force_fp32
from mmdet.ops import DeltaCPooling, DeltaRPooling
from ..builder import HEADS
from ..losses import accuracy
from ..roi_heads import BBoxHead
...
class TSDConvFCBBoxHead(BBoxHead):
    ...
    def __init__(self,
        ...
        # add shared fc and specific fcs to generate delta_c and delta_r
        # for disentangling input proposals
        ...
        if self.with_cls:
            ...
            self.TSD_fc_cls = nn.Linear(self.TSD_cls_last_dim,
                                        self.num_classes)
        if self.with_reg:
    ...
    def init_weights(self):
        ...
        for module_list in [
                self.shared_fcs, self.cls_fcs, self.reg_fcs, self.TSD_pc_fcs,
                self.TSD_pr_fcs, self.TSD_cls_fcs, self.TSD_reg_fcs
        ]:
